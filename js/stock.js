var stockDate = {
    ...
    getSearchDate: function() {
        var suggest = searchStock({
            ...
            id: 'stock',
            minInputLen: 0,
            url: 'http://suggest3.sinajs.cn/suggest/?type=&key={%input%}',
            dataType: 'script',
            pick: function(value) {
            ...
            processData: function(inputValue, data) {
                if (window.suggestvalue) {
                    var result = [];
                    var stock_arry;
                    data = window.suggestvalue.split(';');
    ...
    modStockListEdit: function() {
        ...
        $("#stock_list").find('.stock_member').removeClass('disabled');
    ...
    dragStockList: function() {
        $("#stock_list").kendoSortable({
            filter: ".stock_member",
            disabled: '.disabled',
            axis: 'y',
            cursor: 'move',
            container: '#stock_list',
            hint: function(element) {
                element.siblings().removeClass('hightLight');
                return element.clone().addClass("drags");
            },
            change: function(e) {
                stockDate.sortStock();
            }
    ...
    updateAllDate: function() {
        ...
        sourseData._showStartData(keyIndexStock, keyMyStock, keySelectStock, true, function(res) {
            //三个指点数
